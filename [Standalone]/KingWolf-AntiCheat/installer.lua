RegisterCommand("kwinstall", function(source, ai, aj)
	if source == 0 then
		print("")
		print("^1**^0kwinstall help> Commands^1**^0")
		print("")
		if ai[1] == "install" then
			ad = KingWolfSCfg.FileName
			if ai[2] == "fx" then
			...
			print("^"..math.random(1, 9).."KWAntiCheat^0: ^1Resources ^0("..af[1].."/"..af[2].." for ^1"..ae.." ^1completed). ^0"..af[3].." ^1skipped.^0")
			print("^"..math.random(1, 9).."KWAntiCheat^0: ^8Restart your server!!!^0")
			af = nil
		elseif ai[1] == "help" then
			print("^1**^5KWAntiCheat Installation^1**")
			print("")
			print("^1[*]^5Usage: ^0\"kwinstall install\" -- for __resource.lua files")
			print("^1[*]^5Usage: ^0\"kwinstall install fx\" -- for fxmanifest.lua files")
			print("----------------------")
			print("^1**^5KWAntiCheat Uninstall^1**")
			print("")
			print("^1[*]^5Usage: ^0\"kwinstall uninstall\" -- for __resource.lua files ")
      print("----------------------")
      print("^1[*]^5Usage: ^0\"kwinstall uninstall fx\" -- for fxmanifest.lua files")
      print("----------------------")
      print("")
      print("^1**^5KWAntiCheat Banreload^1**")
      print("^1[*]^5Usage: ^0\"kingwolfreload")
			print("----------------------")
			print("^1[*]^8Help: ^0kwinstall help^0")
		end;
		if ai[1] == "uninstall" then
			if not af then
				...
				print("^"..math.random(1, 9).."KWAntiCheat^0: ^1Resources ^0("..af[1].."/"..af[2].." for ^1"..ae.." completed). ^0"..af[3].." ^1skipped.^0")
				print("^"..math.random(1, 9).."KWAntiCheat^0: ^8Restart your server!!!^0")
				af = nil
		end
	else
		...
		if not ao then
			...
			if av then
				...
				if ap then
					...
					ap:close()
					af[1] = af[1] + 1;
					print("^"..math.random(1, 9).."KWAntiCheat^0: ^2Installation ^0"..ar.." ^2completed.^0")
				else
					print("^"..math.random(1, 9).."KWAntiCheat^0: ^8Installation failed on ^0"..ar.."^8.^0")
				end;
				af[2] = af[2] + 1
			else
				af[3] = af[3] + 1
			...
			if au then
				...
				if ap then
					...
					print("^8Failed uninstalling KWAntiCheat from "..ar..".^0")
					print("^8Make sure you are using the right variable!!!.^0")
					au, av = false, false
				end
			end;
			if au or av then
				print("^"..math.random(1, 9).."KWAntiCheat^0: ^2Uninstalled from ^0"..ar.." ^2successfully.^0")
				af[1] = af[1] + 1
			end
		end
	else
