...
mechanicMenu = function(veh)
	...
	MenuTitle = "Sửa chữa"
	ClearMenu()
	Menu.addButton("Hành động", 'doAction', veh)
	Menu.addButton("Đóng", "CloseMenu", nil)
...
RegisterNetEvent("pepe-repair:client:triggerMenu")
AddEventHandler("pepe-repair:client:triggerMenu", function()
