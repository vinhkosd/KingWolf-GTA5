...
module.exports = {
    ...
    run: async (client, interaction, args) => {
        if (GetResourceState("pepe-weathersync") !== "started") return interaction.reply({ content: "This command requires Framework's `pepe-weathersync` to work", ephemeral: false });
        // doesn't give any feedback to rely on :/
        emit("pepe-weathersync:server:setTime", args.hour, "0");
