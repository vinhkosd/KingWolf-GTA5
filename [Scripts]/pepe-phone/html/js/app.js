                    ...
                    $.post('http://pepe-phone/GetPlayerKeys', JSON.stringify({}), function(Keys){
                        ...
                        if (Keys.length > 0) {
                            $.each(Keys, function(i, key){
                                var elem = '<div class="mykeys-key" id="keyid-'+i+'"> <span class="mykeys-key-label">' + key.HouseData['Adres'] + '</span> <span class="mykeys-key-sub">Click to set GPS</span> </div>';
        ...
        switch(event.data.action) {
            ...
            case "UpdateCallTime":
                ...
                if (!QB.Phone.Data.IsOpen) {
                    ...
                    $(".call-notifications-title").html("Đang nghe ("+timeString+")");
                    $(".call-notifications-content").html("Đang gọi "+event.data.Name);
                ...
                $(".phone-currentcall-title").html("Trong cuộc trò chuyện ("+timeString+")");
                break;
