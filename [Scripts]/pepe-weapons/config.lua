...
Config.WeaponsList = {
 ...
 [GetHashKey('weapon_crowbar')]  = {['Name'] = 'CrowBar',     ['IdName'] = 'weapon_crowbar',  ['AmmoType'] = 'AMMO_MELEE', ['MaxAmmo'] = nil, ['Recoil'] = nil},
