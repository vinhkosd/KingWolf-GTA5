...
Framework.Functions.CreateCallback('pepe-vehicleshop:server:get:config', function(source, cb)
    cb(Config)
end)

Framework.Functions.CreateCallback('pepe-vehicleshop:server:check:owner', function(source, cb, plate)
...
RegisterNetEvent('pepe-vehicleshop:server:sell:vehicle')
AddEventHandler('pepe-vehicleshop:server:sell:vehicle', function(Plate, Price)
    local Player = Framework.Functions.GetPlayer(source)
...
RegisterServerEvent('pepe-vehicleshop:server:buy:vehicle')
AddEventHandler('pepe-vehicleshop:server:buy:vehicle', function(Vehicle, Price)
    local src = source
    ...
    if BankBalance >= Price then
        ...
        TriggerClientEvent('pepe-vehicleshop:client:spawn:bought:vehicle', src, Vehicle, Plate)
    else
