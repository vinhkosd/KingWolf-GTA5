...
RegisterNetEvent('Framework:Player:GetSalary')
AddEventHandler('Framework:Player:GetSalary', function()
	TriggerServerEvent('Framework:GetSalary')
end)
...
RegisterNetEvent('Framework:Command:GoToMarkerHighLanding')
AddEventHandler('Framework:Command:GoToMarkerHighLanding', function()
	Citizen.CreateThread(function()
		local entity = PlayerPedId()
		if IsPedInAnyVehicle(entity, false) then
			entity = GetVehiclePedIsUsing(entity)
