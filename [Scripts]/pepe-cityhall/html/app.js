...
$('.cityhall-option-block').click(function(e){
    ...
    if (blockPage == "identity") {
        ...
        $(".identity-page-blocks").html('<div class="identity-page-block" data-type="id-kaart" onmouseover="'+hoverDescription("id-kaart")+'" onmouseout="'+hoverDescription("id-kaart")+'"><p>IDG</p></div>');
...
hoverDescription = function(type) {
    if (!mouseOver) {
        if (type == "id-kaart") {
            ...
            $(".hover-description").html('<p>Bạn bắt buộc phải mang theo thẻ căn cước trên người. <br> Điều này là để bạn xác định chính mình bất cứ lúc nào.</p>');
...
$(document).on("click", ".identity-page-block", function(e){
    ...
    if (selectedIdentity == null) {
        ...
        if (idType== "id-kaart") {
            ...
            $(".request-identity-button").html("<p>Thẻ căn cước (€50,-)</p>")
        } else {
            $(".request-identity-button").fadeIn(100);
