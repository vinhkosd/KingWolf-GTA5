...
module.exports = {
    name: "kick",
    description: "Kick người chơi ra khỏi server",
    ...
    run: async (client, interaction, args) => {
        ...
        client.utils.log.info(`[${interaction.member.displayName}] Kick ${GetPlayerName(args.id)} (${args.id}). Reason: ${reason}`);
        return interaction.reply({ content: `${GetPlayerName(args.id)} (${args.id}) đã bị kick khỏi server.`, ephemeral: false });
    },
};
