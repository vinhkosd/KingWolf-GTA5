...
Config = {} 
Config.DamageNeeded = 200.0 -- 100.0 being broken and 1000.0 being fixed a lower value than 100.0 will break it
...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        local closestVehicle, Distance = Framework.Functions.GetClosestVehicle()
            ...
            if Vehicle.Vehicle ~= nil then
                ...
                if IsControlPressed(0, Keys["LEFTSHIFT"]) and IsVehicleSeatFree(Vehicle.Vehicle, -1) and not IsEntityAttachedToEntity(ped, Vehicle.Vehicle) and IsControlJustPressed(0, Keys["E"])  and (GetVehicleEngineHealth(Vehicle.Vehicle) <= Config.DamageNeeded or vehicleFuel < 5) then
                    ...
                    while true do
                        ...
                        if Vehicle.IsInFront then
                            SetVehicleForwardSpeed(currentVehicle, -2.6)
                        else
                            SetVehicleForwardSpeed(currentVehicle, 2.6)
                        end
