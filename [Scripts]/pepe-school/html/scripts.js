...
var nbAnswerNeeded = 4; // out of nbQuestionToAnswer
...
$(".btnQuestion").click(function () {
	$.post('http://pepe-school/question', JSON.stringify({}));
});

$(".btnBuyDriveCard").click(function () {
	$.post('http://pepe-school/buyDriveCard', JSON.stringify({}));
});

$(".btnClosePanel").click(function () {
	$.post('http://pepe-school/closePanel', JSON.stringify({}));
	userAnswer = [];
	goodAnswer = [];
	questionUsed = [];
	questionNumber = 1;
...
$(".btnClose").click(function () {
	$.post('http://pepe-school/close', JSON.stringify({}));
	userAnswer = [];
	goodAnswer = [];
	questionUsed = [];
	questionNumber = 1;
...
$(".btnKick").click(function () {
	$.post('http://pepe-school/kick', JSON.stringify({}));
	userAnswer = [];
	goodAnswer = [];
	questionUsed = [];
	questionNumber = 1;
