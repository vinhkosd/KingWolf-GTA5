...
$(document).on('click', '#garage-pricescreen-sellveh', function(e){
    ...
    if (vehicle !== "") {
        ...
        QB.Phone.Notifications.Add("fas fa-car", "Autoscout24", "Xe được đặt trên AutoStos24!", "#f39c12", 2000);
    } else {
        QB.Phone.Notifications.Add("fas fa-times-circle", "Op...", "Đã xảy ra lỗi, thử lại sau ...", "#e74c3c", 2000);
    }
