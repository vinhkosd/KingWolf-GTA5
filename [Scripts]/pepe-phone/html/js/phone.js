                ...
                if (status.CanCall) {
                    if (!status.InCall) {
                        if (QB.Phone.Data.AnonymousCall) {
                            QB.Phone.Notifications.Add("fas fa-phone", "Điện thoại", "Bạn đã bắt đầu một cuộc gọi nặc danh!");
                        }
                        ...
                        QB.Phone.Notifications.Add("fas fa-phone", "Telefoon", "Bạn đang nói chuyện! ");
                    }
                } else {
                    QB.Phone.Notifications.Add("fas fa-phone", "Điện thoại", "Người này đang trong một cuộc trò chuyện!");
                }
            } else {
                QB.Phone.Notifications.Add("fas fa-phone", "Điện thoại", "Người này không có sẵn!");
            }
        } else {
            QB.Phone.Notifications.Add("fas fa-phone", "Điện thoại", "Bạn không thể gọi số của riêng bạn! ");
        }
    });
});
            ...
            if (status.IsOnline) {
                if (status.CanCall) {
                    if (!status.InCall) {
                        ...
                        QB.Phone.Notifications.Add("fas fa-phone", "Điện thoại", "Bạn đang nói chuyện!");
                    }
                } else {
                    QB.Phone.Notifications.Add("fas fa-phone", "Điện thoại", "Người này đang nói chuyện!");
                }
            } else {
                QB.Phone.Notifications.Add("fas fa-phone", "Điện thoại", "Người này không có sẵn!");
            }
...
$(document).on('click', '#new-chat-phone', function(e){
    ...
    if (ContactData.number !== QB.Phone.Data.PlayerData.charinfo.phone) {
        ...
        QB.Phone.Notifications.Add("fa fa-phone-alt", "Điện thoại", "Bạn không thể tự mình ứng dụng..", "default", 3500);
    }
});
...
$(document).on('click', '#edit-contact-save', function(e){
    ...
    if (ContactName != "" && ContactNumber != "") {
        ...
        QB.Phone.Notifications.Add("fas fa-exclamation-circle", "Chỉnh sửa liên lạc", "Điền vào tất cả các lĩnh vực!");
    }
});
...
$(document).on('click', '#add-contact-save', function(e){
    ...
    if (ContactName != "" && ContactNumber != "") {
        ...
        QB.Phone.Notifications.Add("fas fa-exclamation-circle", "Thêm liên lạc", "Điền vào tất cả các lĩnh vực!");
    }
});
...
IncomingCallAlert = function(CallData, Canceled, AnonymousCall) {
    if (!Canceled) {
        if (!QB.Phone.Data.CallActive) {
            ...
            QB.Phone.Animations.TopSlideUp('.'+QB.Phone.Data.currentApplication+"-app", 400, -160);
            setTimeout(function(){
                var Label = `Bạn có một cuộc gọi đến từ ${CallData.name} (${CallData.number})`
                // var Label = "Số điện thoại: "+CallData.number
                if (AnonymousCall) {
                    Label = "Bạn được gọi bởi một số ẩn danh"
                }
                ...
                $(".phone-call-ongoing").css({"display":"none"});
                $(".phone-call-incoming-caller").html(`${CallData.name} (${CallData.number})`);
                $(".phone-app").css({"display":"none"});
                QB.Phone.Functions.HeaderTextColor("white", 400);
