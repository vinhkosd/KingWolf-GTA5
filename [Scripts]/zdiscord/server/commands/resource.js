...
module.exports = {
    ...
    run: async (client, interaction, args) => {
        ...
        if (!(args.refresh || args.inspect) && args.script == "pepe-core") return interaction.reply({ content: "You should never restart this script as it will break your server", ephemeral: true });
