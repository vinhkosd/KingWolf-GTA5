...
Config.UsePedModelsInsteadOutfitsForPlayers = true -- Useful when you want to use ped models and don't want to use multiplayer clothes
Config.UsePedModelsInsteadOutfitsForGuards = true -- Useful when you want to use ped models and don't want to use multiplayer clothes
