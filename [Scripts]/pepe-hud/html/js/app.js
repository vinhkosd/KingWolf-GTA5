...
(() => {
    ...
    QBHud.CarHud = function(data) {
        if (data.show) {
            ...
            $('.stress-circle').animate({"left": "6.5vh"});
    ...
    QBHud.UpdateHud = function(data) {
        ...
        Progress(data.oxy, ".oxy");

        $('fuel').fadeIn(450);
        //Progress(data.fuel.toFixed(0), ".fuel");
        Progress(data.fuel, ".fuel");
