...
Config.IBANPrefix = "KW" -- the prefix of the IBAN

Config.IBANNumbers = 12 -- How many characters the IBAN has by default

Config.CustomIBANMaxChars = 14 -- How many characters the IBAN can have when changing it to a custom one (on Settings tab)
