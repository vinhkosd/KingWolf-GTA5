...
RegisterNetEvent('pepe-prison:client:set:in:jail')
AddEventHandler('pepe-prison:client:set:in:jail', function(Name, Months, CitizenId, Date)
...
function JailIntro(Name, Months, CitizenId, Date)
    ...
    TriggerEvent('pepe-sound:client:play', 'handcuff', 0.4)
    ...
    TriggerEvent('pepe-sound:client:play', 'jail-photo', 0.4)
    Citizen.Wait(3000) 
    TriggerEvent('pepe-sound:client:play', 'jail-photo', 0.4)
    Citizen.Wait(3000) 
    ...
    TriggerServerEvent("pepe-prison:server:set:jail:items", Months)
    TriggerEvent('pepe-prison:client:enter:prison', Months, true)
...
function AddMugshot(Name, Months, CitizenId, Date)
 ...
 exports['pepe-assets']:RequestAnimationDict("mp_character_creation@lineup@male_a")
