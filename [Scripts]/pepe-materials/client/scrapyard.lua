...
AddEventHandler('pepe-materials:client:scrap:vehicle', function()
    ...
    if Config.CanScrap then
        ...
        -- if not IsOwned then
	    	...
	    	Framework.Functions.Progressbar("scrap-vehicle", "Đang rã xe..", Time, false, true, {
      ...
      Framework.Functions.Notify("Vui lòng chờ thêm 5 phút vì bạn đã rã xe trước đó..", "error")	
    end								
end)
