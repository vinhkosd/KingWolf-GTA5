...
AddEventHandler('pepe-sound:server:play:distance', function(maxDistance, soundFile, soundVolume, coords)
    TriggerClientEvent('pepe-sound:client:play:distance', -1, source, maxDistance, soundFile, soundVolume, coords)
end)