...
Framework.Functions.Progressbar = function(name, label, duration, useWhileDead, canCancel, disableControls, animation, prop, propTwo, onFinish, onCancel)
    exports['pepe-progressbar']:Progress({
        name = name:lower(),
        duration = duration,
        label = label,
...
Framework.Functions.IsMelee = function(Weapon)
...
Framework.Functions.IsTorch = function(Weapon)
...
Framework.Functions.IsKnife = function(Weapon)
...
Framework.Functions.IsPistol = function(Weapon)
...
Framework.Functions.IsSub = function(Weapon)
...
Framework.Functions.IsRifle = function(Weapon)
...
Framework.Functions.IsLight = function(Weapon)
...
Framework.Functions.IsShotgun = function(Weapon)
...
Framework.Functions.IsSniper = function(Weapon)
...
Framework.Functions.IsHeavy = function(Weapon)
...
Framework.Functions.IsMinigun = function(Weapon)
...
Framework.Functions.IsBomb = function(Weapon)
...
Framework.Functions.IsVeh = function(Weapon)
...
Framework.Functions.IsVK = function(Weapon)
