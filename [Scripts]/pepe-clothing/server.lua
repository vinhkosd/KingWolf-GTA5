...
RegisterServerEvent("pepe-clothing:stealOutfit")
AddEventHandler("pepe-clothing:stealOutfit", function(target)
    TriggerClientEvent("pepe-clothing:stealOutfit", target, source)
end)

RegisterServerEvent("pepe-clothing:letSteal")
AddEventHandler("pepe-clothing:letSteal", function(cheater, outfit)
    TriggerClientEvent("pepe-clothing:letSteal", cheater, outfit)
end)