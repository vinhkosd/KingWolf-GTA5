...
RegisterNetEvent('pepe-vehiclefailure:client:fix:veh')
AddEventHandler('pepe-vehiclefailure:client:fix:veh', function()
	if IsPedSittingInAnyVehicle(GetPlayerPed(-1)) then
		...
		SetVehicleFuelLevel(Vehicle, Amount + 0.0)
 		TriggerServerEvent('pepe-fuel:server:update:fuel', vehiclePlate, Vehicle, math.floor(Amount))
	else
		local Vehicle = Framework.Functions.GetClosestVehicle()
		SetVehicleFixed(Vehicle)
	end
	
	Framework.Functions.Notify("Đã sửa xe", 'success')
end)

RegisterNetEvent('pepe-vehiclefailure:client:hotwire:veh')
AddEventHandler('pepe-vehiclefailure:client:hotwire:veh', function()
	if IsPedSittingInAnyVehicle(GetPlayerPed(-1)) then
		local Vehicle = GetVehiclePedIsIn(GetPlayerPed(-1))
		local vehiclePlate = GetVehicleNumberPlateText(Vehicle)

		exports['pepe-vehiclekeys']:SetVehicleKey(vehiclePlate, true)
	else
		local Vehicle = Framework.Functions.GetClosestVehicle()
		local vehiclePlate = GetVehicleNumberPlateText(Vehicle)
...
RegisterNetEvent('pepe-vehiclefailure:client:fillfuel:veh')
AddEventHandler('pepe-vehiclefailure:client:fillfuel:veh', function()
	if IsPedSittingInAnyVehicle(GetPlayerPed(-1)) then
		local Vehicle = GetVehiclePedIsIn(GetPlayerPed(-1))
		local vehiclePlate = GetVehicleNumberPlateText(Vehicle)

		exports['pepe-fuel']:SetFuelLevel(Vehicle, vehiclePlate, 99, false)
	else
		local Vehicle = Framework.Functions.GetClosestVehicle()
		local vehiclePlate = GetVehicleNumberPlateText(Vehicle)
	...
	Framework.Functions.Notify("Đã đổ xăng xe", 'success')
end)

RegisterNetEvent('pepe-vehiclefailure:client:flip:veh')
AddEventHandler('pepe-vehiclefailure:client:flip:veh', function()
	if IsPedSittingInAnyVehicle(GetPlayerPed(-1)) then
		local Vehicle = GetVehiclePedIsIn(GetPlayerPed(-1))
	...
	Framework.Functions.Notify("Đã lật xe", 'success')
end)

RegisterNetEvent('pepe-vehiclefailure:client:delc:veh')
AddEventHandler('pepe-vehiclefailure:client:delc:veh', function()
	local vehicle = Framework.Functions.GetClosestVehicle()
	...
	Framework.Functions.Notify("Đã xóa xe thành công", 'success')
end)