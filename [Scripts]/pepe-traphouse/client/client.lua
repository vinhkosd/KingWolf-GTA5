         ...
         if LoggedIn then
            if InSideTrap then
                ...
                if (GetDistanceBetweenCoords(PlayerCoords.x, PlayerCoords.y, PlayerCoords.z, Config.TrapHouse["Coords"]['Enter']["X"] - OffSets.exit.x, Config.TrapHouse["Coords"]['Enter']["Y"] -  OffSets.exit.y, Config.TrapHouse["Coords"]['Enter']["Z"] -  OffSets.exit.z, true) < 3.0) then
                    ...
                    DrawText3D(Config.TrapHouse["Coords"]['Enter']["X"] - OffSets.exit.x, Config.TrapHouse["Coords"]['Enter']["Y"] -  OffSets.exit.y, Config.TrapHouse["Coords"]['Enter']["Z"] -  OffSets.exit.z, '~g~E~s~ - Ra ngoài')
                  ...
                  if (GetDistanceBetweenCoords(PlayerCoords.x, PlayerCoords.y, PlayerCoords.z, Config.TrapHouse["Coords"]['Interact']["X"], Config.TrapHouse["Coords"]['Interact']["Y"], Config.TrapHouse["Coords"]['Interact']["Z"], true) < 3.0) then
                    if Config.IsSelling then
                        ...
                        DrawText3D(Config.TrapHouse["Coords"]['Interact']["X"], Config.TrapHouse["Coords"]['Interact']["Y"], Config.TrapHouse["Coords"]['Interact']["Z"] + 0.15, '~o~Đang bán đồ..')
                    else
                        ...
                        DrawText3D(Config.TrapHouse["Coords"]['Interact']["X"], Config.TrapHouse["Coords"]['Interact']["Y"], Config.TrapHouse["Coords"]['Interact']["Z"] + 0.15, '~g~E~s~ - Bán đồ')
                        if IsControlJustReleased(0, 38) then
                            TryToSell()
                        end
                    end
