...
- New Add/Remove permissions command for Framework


**3.1.0 - Framework (potential ESX) support added [2021-7-10]**

- Commands starting with `qb-` will load automatically if Framework is detected.
