...
RegisterNetEvent('pepe-hud:client:show:cash')
AddEventHandler('pepe-hud:client:show:cash', function()
    SendNUIMessage({action = 'ShowCash'})
end)

RegisterNetEvent('pepe-hud:client:show:current:players')
AddEventHandler('pepe-hud:client:show:current:players', function()
    TriggerEvent('chatMessage', "SYSTEM", "cash", "Online Spelers: "..GetCurrentPlayers().."/64")
end)

RegisterNetEvent("pepe-hud:client:money:change")
AddEventHandler("pepe-hud:client:money:change", function(Amount, Type)
