...
AddEventHandler('Framework:Client:OnPlayerLoaded', function()
 Citizen.SetTimeout(1250, function()
     ...
     Citizen.Wait(250)
     Framework.Functions.TriggerCallback("pepe-cardealer2:server:get:config", function(ConfigData)
        Config = ConfigData
     end)
     LoggedIn = true
 end)
...
RegisterNetEvent('pepe-cardealer2:client:open:tablet')
AddEventHandler('pepe-cardealer2:client:open:tablet', function()
...
RegisterNUICallback('GetStockVehicles', function(data, cb)
    Framework.Functions.TriggerCallback('pepe-cardealer2:server:get:storage:cars', function(StockData)
        cb(StockData)
    end)
end)
