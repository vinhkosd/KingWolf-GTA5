...
AddEventHandler('pepe-materials:client:search:trash', function()
    ...
    if BinModel ~= nil then
      if not Config.OpenedBins[BinModel] then
        Framework.Functions.Progressbar("search-trash", "Lục thùng rác..", math.random(10000, 12500), false, true, {
            ...
            SetBinUsed(BinModel)
            TriggerServerEvent('pepe-materials:server:get:reward')
        ...
        Framework.Functions.Notify("Thùng này đã có người lục..", "error")
      end
    end
end)
