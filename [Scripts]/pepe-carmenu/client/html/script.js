...
$(function () {
    ...
    $('.door').on('click', function() {
        ...
        $.post('http://pepe-carmenu/openDoor', JSON.stringify({
                doorIndex: doorIndex
            })
        );
    });
    ...
    $('.seat').on('click', function() {
        ...
        $.post('http://pepe-carmenu/switchSeat', JSON.stringify({
                seatIndex: seatIndex
            })
        );
    });
    ...
    $('.window').on('click', function() {
        ...
        $.post('http://pepe-carmenu/togglewindow', JSON.stringify({
    ...
    $('.engine').on('click', function() {
        if ($(this).parent().hasClass('disabled')) return;
        $.post('http://pepe-carmenu/toggleengine', JSON.stringify({}));
    });
    ...
    document.onkeyup = function (data) {
        if (open) {
            ...
            if ((
                ...
                // Z or Esc
                $.post('http://pepe-carmenu/escape', JSON.stringify({}));
            }
        }
    };
});
