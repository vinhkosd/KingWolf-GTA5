...
Config.ClothingRooms = {
    ...
    -- table = { x = -336.1567, y = -165.7059, z = 43.937778, h = 186.40594 }
    -- [5] = {requiredJob = "mechanic", x = -336.1567, y = -165.7059, z = 43.937778, cameraLocation = {x = -336.1567, y = -165.7059, z = 43.937778, h = 266.40594 }},
    [5] = {requiredJob = "mechanic", x = -311.6578, y = -137.6444, z = 39.00951, cameraLocation = {x = 301.09, y = -596.09, z = 43.28, h = 157.5}},
    [6] = {requiredJob = "kfc", x = 337.27334, y = -894.6288, z = 29.339906, cameraLocation = {x = 338.04031, y = -894.0693, z = 29.339904, h = 181.46627}},
    -- table = { x = -198.772, y = -1333.896, z = 30.237968, h = 139.03729 }
    [7] = {requiredJob = "bennys", x = -198.772, y = -1333.896, z = 30.237968, cameraLocation = { x = -198.772, y = -1333.896, z = 30.237968, h = 139.03729}},
    -- -311.6578, -137.6444, 39.00951, 37.924354
    -- pizza = { ['x'] = -578.4588, ['y'] = -403.0712, ['z'] = 34.917022, ['h'] = 94.021881 }
    -- camlocate = { x = -580.5437, y = -403.0799, z = 34.917022, h = 271.21447 }
    [8] = {requiredJob = "pizza", x = -578.4588, y = -403.0712, z = 34.917022, cameraLocation = { x = -580.5437, y = -403.0799, z = 34.917022, h = 271.21447}},
        ...
        ["male"] = {
            [1] = {
                ...
                outfitData = {
                    ...
                    ["arms"]        = { item = 74, texture = 0},  -- Armen
                    ["t-shirt"]     = { item = 15, texture = 0},  -- T Shirt
                    ["vest"]        = { item = 0, texture = 0},  -- Body Vest
                    ["torso2"]      = { item = 9, texture = 14},  -- Jas / Vesten
                    ["shoes"]       = { item = 3, texture = 4},  -- Schoenen
