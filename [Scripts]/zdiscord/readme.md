...
A Discord bot that runs in FiveM for the purpose of whitelisting, moderation and utilities using [discord.js](https://discord.js.org/). The goal is for this this resource to be easy to setup and expand upon while giving your staff team an easy method of support and moderation of players in game without actually launching FiveM. This resource also heavily support [Framework](https://github.com/Framework-framework) in most of it's functionality but it's not required
...
- [Framework](https://github.com/Framework-framework) [commands](https://zfbx.github.io/zdiscord/commands) included!
...
*Please note we only support the official, free and open source, [Framework](https://github.com/Framework-framework) framework and not old "qbus" or paid copies of Framework*
