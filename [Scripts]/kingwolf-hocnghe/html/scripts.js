...
function openQuestionnaire() {
	...
	$("#questionNumero").html("Câu hỏi: " + questionNumber);
...
$(".btnQuestion").click(function () {
	$.post('http://kingwolf-hocnghe/question', JSON.stringify({}));
});

$(".btnClosePanel").click(function () {
	$.post('http://kingwolf-hocnghe/closePanel', JSON.stringify({}));
	userAnswer = [];
	goodAnswer = [];
	questionUsed = [];
	questionNumber = 1;
...
$(".btnClose").click(function () {
	$.post('http://kingwolf-hocnghe/close', JSON.stringify({}));
	userAnswer = [];
	goodAnswer = [];
	questionUsed = [];
	questionNumber = 1;
...
$(".btnKick").click(function () {
	$.post('http://kingwolf-hocnghe/kick', JSON.stringify({}));
	userAnswer = [];
	goodAnswer = [];
	questionUsed = [];
	questionNumber = 1;
