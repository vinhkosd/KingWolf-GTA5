...
window.addEventListener('message', function(event) {
	...
	switch (event.data.action) {
			...
			$('#top-search').html(`
				...
				<div class="btn-group" style="margin-right: 10px;">
					...
					<ul class="dropdown-menu">
						<li><a class="dropdown-item selected" id="newest">Mới nhất</a></li>
						<li><a class="dropdown-item" id="lowest">Giá thấp đến cao</a></li>
						<li><a class="dropdown-item" id="highest">Giá cao đến thấp</a></li>
					</ul>
				</div>
				<button type="button" id="refreshbtn" class="btn btn-blue"><i class="fas fa-sync-alt"></i></button>
				<button type="button" id="placeAd" class="btn btn-blue adbtn" data-bs-toggle="modal" data-bs-target="#placeAdModalVehicles"><i class="fas fa-plus"></i> Đăng bán</button>
			`);

			if(event.data.accessBlackmarket) {
				$('#sidebar').html(`
					<p class="sidebar-item mt-2 selected" id="vehicles_page" style="margin-bottom: 12px;"><i class="fas fa-car"></i> <span class="ms-1">Phương tiện</span></p>
					<p class="sidebar-item" id="items_page" style="margin-bottom: 12px;"><i class="fas fa-box"></i> <span class="ms-1">Vật phẩm</span></p>
					<p class="sidebar-item" id="blackmarket_page" style="margin-bottom: 12px;"><i class="fas fa-user-ninja"></i> <span class="ms-1">Chợ đen</span></p>
				`);

				$('#sidebar-personal').html(`
					<p class="sidebar-item mt-2 position-relative" id="myads_page" style="margin-bottom: 12px;">
						<i class="fas fa-bullhorn"></i> <span class="ms-1">Mặt hàng của tôi</span>
					...
					<div class="col-md-3">
						<div class="card item_card d-flex flex-column">
							<div class="card-body text-center flex-grow-1 d-flex flex-column justify-content-between pb-1 align-items-center">
								<span class="infohover" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="top" data-bs-html="true" data-bs-content="<div><b>Người bán:</b> ${vehiclesAds[i].author_name}</div><div><b>Phone:</b> ${vehiclesAds[i].phone_number}</div><div><b>Nội dung:</b> ${vehiclesAds[i].description.toHtmlEntities()}</div>" data-bs-trigger="hover"><i class="fas fa-info-circle"></i></span>
							...
							<a id="buyVehicle" href="#" class="btn btn-blue d-block item_card-btn" data-bs-toggle="modal" data-bs-target="#${vehiclesAds[i].item_id}"><i class="fas fa-shopping-cart"></i> MUA</a>
						</div>
					</div>
				`;
										...
										<div class="modal-content myinvoices_modal-content">
											<div class="modal-body p-4">
												<div class="text-center">
													<span style="font-weight: 600; font-size: 40px; text-align: center;">Xác nhận mua hàng?</span>
												</div>
												<hr>
												<button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" id="closeDepositMoneyModal"></button>
												<div class="text-center" style="font-size: 30px; font-weight: 500;">${vehiclesAds[i].label} với giá ${vehiclesAds[i].price}$</div>
												<div class="d-flex justify-content-center align-items-center" style="margin-top: 10px;">
													<a id="cancelAction" href="#" class="btn btn-dark d-block w-50" style="border-radius: 10px; font-size: 30px; margin-right: 15px;" data-bs-dismiss="modal"><i class="fas fa-times"></i> HUỶ BỎ</a>
													<a id="confirmAction" href="#" class="${vehiclesAds[i].item_id} btn btn-blue d-block w-50" style="border-radius: 10px; font-size: 30px;" data-bs-dismiss="modal"><i class="fas fa-shopping-cart"></i> MUA</a>
												</div>
											</div>
										</div>
									</div>
			...
			if(added == 0) {
				row = `<div class="d-flex justify-content-center align-items-center h-100 flex-column">
							<div class="d-flex justify-content-center">
								<span class="text-center" id="info-text">Không có mặt hàng nào có sẵn</span>
							</div>
							<div>
								<button type="button" id="refreshbtn2" class="btn btn-blue"><i class="fas fa-sync-alt"></i> Làm mới</button>
							</div>
						</div>`;
			}
		...
		case 'updateItems':
			...
			$('#page-title').html(`Vật phẩm`);

			$('#sidebar').html(`
				<p class="sidebar-item mt-2" id="vehicles_page" style="margin-bottom: 12px;"><i class="fas fa-car"></i> <span class="ms-1">Phương tiện</span></p>
				<p class="sidebar-item selected" id="items_page" style="margin-bottom: 12px;"><i class="fas fa-box"></i> <span class="ms-1">Vật phẩm</span></p>
				<p class="sidebar-item" id="blackmarket_page" style="margin-bottom: 12px;"><i class="fas fa-user-ninja"></i> <span class="ms-1">Chợ đen</span></p>
			`);
			...
			for(var i = 0; i < num2; i++) {
				...
				row += `
					<div class="col-md-3">
						<div class="card item_card d-flex flex-column">
							<div class="card-body text-center flex-grow-1 d-flex flex-column justify-content-between pb-1 align-items-center">
								<span class="infohover" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="top" data-bs-html="true" data-bs-content="<div><b>Người bán:</b> ${itemsAds[i].author_name}</div><div><b>Phone:</b> ${itemsAds[i].phone_number}</div><div><b>Nội dung:</b> ${itemsAds[i].description.toHtmlEntities()}</div>" data-bs-trigger="hover"><i class="fas fa-info-circle"></i></span>
							...
							<a id="buyVehicle" href="#" class="btn btn-blue d-block item_card-btn" data-bs-toggle="modal" data-bs-target="#${modal_id}"><i class="fas fa-shopping-cart"></i> MUA</a>
						</div>
					</div>
				`;
				if ((added) % 4 === 0) {
									...
									<div class="modal-dialog modal-lg modal-dialog-centered" style="width: 500px;">
										<div class="modal-content myinvoices_modal-content">
											<div class="modal-body p-4">
												...
												<hr>
												<button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" id="closeDepositMoneyModal"></button>
												<div class="text-center" style="font-size: 30px; font-weight: 500;">${itemsAds[i].label} với giá ${itemsAds[i].price}$</div>
												<div class="d-flex justify-content-center align-items-center" style="margin-top: 10px;">
													<a id="cancelAction" href="#" class="btn btn-dark d-block w-50" style="border-radius: 10px; font-size: 30px; margin-right: 15px;" data-bs-dismiss="modal"><i class="fas fa-times"></i> HUỶ BỎ</a>
													<a id="confirmAction" href="#" class="${modal_id} btn btn-blue d-block w-50" style="border-radius: 10px; font-size: 30px;" data-bs-dismiss="modal"><i class="fas fa-shopping-cart"></i> MUA</a>
												</div>
											</div>
										</div>
									</div>
		...
		case 'updateBlackmarket':
			...
			$('#page-title').html(`Chợ đen`);

			$('#sidebar').html(`
				<p class="sidebar-item mt-2" id="vehicles_page" style="margin-bottom: 12px;"><i class="fas fa-car"></i> <span class="ms-1">Phương tiện</span></p>
				<p class="sidebar-item" id="items_page" style="margin-bottom: 12px;"><i class="fas fa-box"></i> <span class="ms-1">Vật phẩm</span></p>
				<p class="sidebar-item selected" id="blackmarket_page" style="margin-bottom: 12px;"><i class="fas fa-user-ninja"></i> <span class="ms-1">Chợ đen</span></p>
			`);
			...
			for(var i = 0; i < num2; i++) {
				...
				row += `
					<div class="col-md-3">
						<div class="card item_card d-flex flex-column">
							<div class="card-body text-center flex-grow-1 d-flex flex-column justify-content-between pb-1 align-items-center">
								<span class="infohover" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="top" data-bs-html="true" data-bs-content="<div><b>Người bán:</b> ${blackmarketAds[i].author_name}</div><div><b>Phone:</b> ${blackmarketAds[i].phone_number}</div><div><b>Nội dung:</b> ${blackmarketAds[i].description.toHtmlEntities()}</div>" data-bs-trigger="hover"><i class="fas fa-info-circle"></i></span>
									...
									<div class="modal-dialog modal-lg modal-dialog-centered" style="width: 500px;">
										<div class="modal-content myinvoices_modal-content">
											<div class="modal-body p-4">
												...
												<hr>
												<button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" id="closeDepositMoneyModal"></button>
												<div class="text-center" style="font-size: 30px; font-weight: 500;">${blackmarketAds[i].label} với giá ${blackmarketAds[i].price}$</div>
												<div class="d-flex justify-content-center align-items-center" style="margin-top: 10px;">
													<a id="cancelAction" href="#" class="btn btn-dark d-block w-50" style="border-radius: 10px; font-size: 30px; margin-right: 15px;" data-bs-dismiss="modal"><i class="fas fa-times"></i> HUỶ BỎ</a>
													<a id="confirmAction" href="#" class="${modal_id} btn btn-blue d-block w-50" style="border-radius: 10px; font-size: 30px;" data-bs-dismiss="modal"><i class="fas fa-shopping-cart"></i> MUA</a>
												</div>
		...
		case 'updateMyAds':
						...
						row += `
							<div class="col-md-3">
								<div class="card item_card">
									<div class="card-body text-center flex-grow-1 d-flex flex-column justify-content-between pb-1 align-items-center">
										<span class="infohover" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="top" data-bs-html="true" data-bs-content="<div><b>Người bán:</b> ${myAds[i].author_name}</div><div><b>Phone:</b> ${myAds[i].phone_number}</div><div><b>Nội dung:</b> ${myAds[i].description.toHtmlEntities()}</div>" data-bs-trigger="hover"><i class="fas fa-info-circle"></i></span>
									...
									<a id="cancelAd" href="#" class="btn btn-blue d-block item_card-btn" data-bs-toggle="modal" data-bs-target="#${modal_id}"><i class="fas fa-times"></i> HUỶ BỎ</a>
								</div>
							</div>
						`;
					} else {
						...
						modal += `<div class="modal fade" id="${modal_id}" tabindex="-1">
									<div class="modal-dialog modal-lg modal-dialog-centered" style="width: 500px;">
										<div class="modal-content myinvoices_modal-content">
											<div class="modal-body p-4">
												<div class="text-center">
													<span style="font-weight: 600; font-size: 40px; text-align: center;">Xác nhận đăng bán?</span>
												</div>
												<hr>
												<button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" id="closeDepositMoneyModal"></button>
			...
			if(added == 0) {
				row = `<div class="d-flex justify-content-center align-items-center h-100 flex-column">
							<div class="d-flex justify-content-center">
								<span class="text-center" id="info-text">Bạn chưa có mặt hàng nào trên chợ</span>
							</div>
						</div>`;
			}
...
$(document).on('click', "#newest", function() {
	if (selectedWindow == "vehicles") {
		...
		$('#top-search').html(`
			...
			<button type="button" id="refreshbtn" class="btn btn-blue"><i class="fas fa-sync-alt"></i></button>
			<button type="button" id="placeAd" class="btn btn-blue adbtn" data-bs-toggle="modal" data-bs-target="#placeAdModalItems"><i class="fas fa-plus"></i> Đăng bán</button>
		`);
	} else if (selectedWindow == "blackmarket") {
		...
		$('#top-search').html(`
			...
			<button type="button" id="refreshbtn" class="btn btn-blue"><i class="fas fa-sync-alt"></i></button>
			<button type="button" id="placeAd" class="btn btn-blue adbtn" data-bs-toggle="modal" data-bs-target="#placeAdModalBlackmarket"><i class="fas fa-plus"></i> Đăng bán</button>
		`);
	}
});
	...
	if (selectedWindow == "vehicles") {
		...
		$('#top-search').html(`
			...
			<div class="btn-group" style="margin-right: 10px;">
				<button type="button" class="btn btn-blue dropdown-toggle sortbtn" data-bs-toggle="dropdown" aria-expanded="false">Sort By</button>
				<ul class="dropdown-menu">
					<li><a class="dropdown-item" id="newest">Mới nhất</a></li>
					<li><a class="dropdown-item selected" id="lowest">Giá thấp đến cao</a></li>
					<li><a class="dropdown-item" id="highest">Giá cao đến thấp</a></li>
				</ul>
			</div>
			<button type="button" id="refreshbtn" class="btn btn-blue"><i class="fas fa-sync-alt"></i></button>
		...
		$('#top-search').html(`
			...
			<div class="btn-group" style="margin-right: 10px;">
				...
				<ul class="dropdown-menu">
					<li><a class="dropdown-item" id="newest">Mới nhất</a></li>
					<li><a class="dropdown-item" id="lowest">Giá thấp đến cao</a></li>
					<li><a class="dropdown-item selected" id="highest">Giá cao đến thấp</a></li>
				</ul>
			</div>
			<button type="button" id="refreshbtn" class="btn btn-blue"><i class="fas fa-sync-alt"></i></button>
			<button type="button" id="placeAd" class="btn btn-blue adbtn" data-bs-toggle="modal" data-bs-target="#placeAdModalVehicles"><i class="fas fa-plus"></i> Đăng bán</button>
