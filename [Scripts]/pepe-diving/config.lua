...
Config = Config or {}
Config.DivingMaxTimeUnderWater = 180.00--muốn càng lâu thì tăng cái này lên
Config.NoDivingGearUnderWater = 45.00
Config.PoliceNeededs = 4
