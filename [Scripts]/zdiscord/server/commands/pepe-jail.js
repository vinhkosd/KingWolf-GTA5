...
module.exports = {
    name: "jail",
    description: "Cho người chơi đi tù",
    ...
    run: async (client, interaction, args) => {
        ...
        return interaction.reply({ content: "Tính năng không thể sử dụng", ephemeral: true });
        // if (args.sentence) {
        ...
        //     emitNet("pepe-police:client:SendToJail", args.id, parseInt(args.time));
        //     emitNet("Framework:Notify", args.id, `You were sent to prison for ${args.time} months`);
