...
try {
    z.Framework = global.exports["pepe-core"].GetCoreObject();
    if (z.Framework) z.utils.log.info("Pepe found! Supported QB commands will be loaded.");
} catch { z.Framework = false; }
